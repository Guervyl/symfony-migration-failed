 ...
 * Entity2
 * 
 * @ORM\Table(name="entity13")
 * @ORM\Entity(repositoryClass="App\Repository\Entity13Repository")
...
class Entity13 
{
    ...
    *
    * @ORM\OneToMany(mappedBy="entity13", cascade={"persist"}, targetEntity="App\Entity\testUniqueAndNullable")
    */private $testUniqueAndNullable;
    ...
    public function addTestUniqueAndNullable(testUniqueAndNullable $testUniqueAndNullable): self
    {
        if (!$this->testUniqueAndNullable->contains($testUniqueAndNullable)) {
            ...
            $testUniqueAndNullable->setEntity13($this);
        }
    ...
    public function removeTestUniqueAndNullable(testUniqueAndNullable $testUniqueAndNullable): self
    {
        if ($this->testUniqueAndNullable->contains($testUniqueAndNullable)) {
            ...
            if ($testUniqueAndNullable->getEntity13() === $this) {
                $testUniqueAndNullable->setEntity13(null);
            }
        }
